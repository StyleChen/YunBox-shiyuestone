...
function wl_reset_general_setting()
{
	...
	update_option('kadima_options',$wl_theme_options);
}
...
{
	$wl_theme_options['footer_customizations']="@ 2016";
	$wl_theme_options['info_copyright']="";
	$wl_theme_options['info_tel']="";
	$wl_theme_options['info_fax']="";
	$wl_theme_options['info_mail']="";
	update_option('kadima_options',$wl_theme_options);
}
